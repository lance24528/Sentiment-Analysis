# This script is used to test the speed of lemmatization using spaCy's language model
# compared to using NLTK's WordNetLemmatizer. The dataset used is the IMDB movie review dataset.
# Result: spaCy is 10 minutes faster than NLTK in lemmatizing 50,000 reviews. test NLTK in kaggle, not sure if this is a fair test but I did this to figure out which i should use.
# Ignore this file if you are not interested in the speed comparison of lemmatization.
